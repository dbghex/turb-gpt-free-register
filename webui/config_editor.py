...
EDITABLE_FIELDS = [
    ...
    },
    {
        ...
        "label": "套餐/Agent专用代理(每行一个)", "help": "用于查套餐、查活和生成 Agent Token；支持动态代理 URL，每行一条。明文显示，便于修改国家、地区和会话参数；仅保存到 .env",
        "storage": "env",
    },
    {
...

    {
        ...
        "label": "接码通道", "help": "grizzly / smsbower / l / h / hero；HeroSMS 的国家、服务和价格请在 HeroSMS 配置区选择",
    },
    {
