...
class RoxyBrowserClient:
    ...
    def open_profile(self, profile_id: str | None = None, proxy_url: str | None = None) -> RoxyOpenResult:
        with _ROXY_WINDOW_CREATE_LOCK:
            return self._open_profile_locked(profile_id, proxy_url=proxy_url)

    def _open_profile_locked(self, profile_id: str | None = None, proxy_url: str | None = None) -> RoxyOpenResult:
